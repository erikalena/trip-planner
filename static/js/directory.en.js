var layer_names = {
    ...
    catholic_churches: { n: "church  [es]", e: "â›ª" },
...
function getCategoryName(kinds) {
    ...
    let idx = 0; // by default choose first definition, if too generic take the second one if present
    if (names[idx] == 'palace' && names.length > 1) idx = 1;
